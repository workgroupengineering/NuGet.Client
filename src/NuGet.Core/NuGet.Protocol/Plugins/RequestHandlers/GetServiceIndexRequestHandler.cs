...
namespace NuGet.Protocol.Plugins
{
    ...
    public sealed class GetServiceIndexRequestHandler : IRequestHandler, IDisposable
    {
        ...
        {
            return HandleResponseAsync(connection, request, responseHandler, NullProtocolDiagnostics.Instance, cancellationToken);
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                serviceIndex = await sourceRepository.GetResourceAsync<ServiceIndexResourceV3>(protocolDiagnostics, cancellationToken);
            }
