...
namespace NuGet.Build.Tasks {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unable to restore the following projects as they are either packages.config based or not NuGet configured..
        /// </summary>
        internal static string Log_UnrestorableProjectTypes {
            get {
                return ResourceManager.GetString("Log_UnrestorableProjectTypes", resourceCulture);
            }
        }
